...
> = {
  "introduction-to-lspd": {
    title: "Introduction To LSPD",
    image: "/Guides/Introduction To LSPD.png",
    summary: "Complete training covering traffic stops (10-51) and arrest procedures (10-15) for LSPD officers.",
    lastUpdated: new Date("2026-07-25"),
    readTime: "15 min",
  },
};
    ...
    <OrganizerLayout header={<SoftwareHeader title="Guides" />}>
      <div className="flex min-h-0 min-w-0 flex-1 flex-col bg-[#f7f8fb] text-[#000000]">
        ...
        <main className="min-h-0 flex-1 overflow-y-auto px-8 py-10">
          {guideId === "introduction-to-lspd" && <IntroductionToLSPDGuide />}
        </main>
      </div>
    </OrganizerLayout>
  );
...
// Introduction To LSPD - Merged Guide Component
function IntroductionToLSPDGuide() {
  return (
    <div className="flex gap-8 max-w-[1400px] mx-auto">
      <article className="flex-1 max-w-3xl prose text-[15px] leading-relaxed text-[#374151] space-y-8">
        ...
        <div className="pb-8 border-b-2 border-gray-200 space-y-8">
          ...
          <section id="step-3" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 3: Vehicle Stop Compliance</h2>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="mt-3 space-y-3 list-disc pl-5 text-[#4b5563]">
                  <li>
          ...
          <section id="step-4" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 4: Initial Radio Dispatch</h2>
            <p className="text-[#4b5563]">
          ...
          <section id="step-5" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 5: Contact Phase</h2>
          ...
          <section id="step-6" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 6: Background Verification</h2>
          ...
          <section id="step-7" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 7: Resolution</h2>
          ...
          <section id="step-8" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 8: Closing Dispatch Notification</h2>
            <p className="text-[#4b5563]">
          ...
          <section id="step-9" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Step 9: Resume Patrol</h2>
            <p className="text-[#4b5563]">
          ...
          <section id="rules-1051" className="space-y-6 pt-4 border-t border-gray-100 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black">
              Warnings & Strict Protocols (10-51)
            </h2>
            ...
            <ul className="space-y-5 list-disc pl-5">
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Always give <strong>3 pullover demands</strong> with a duration of 5 seconds between each demand before blocking the engine.</p>
              </li>
              <li>
                <strong className="text-black">No Ramming <span className="text-red-600">(Car Ramming | Jail 120 min)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Do <strong>not</strong> ram anyone to stop their car, even if you cannot block their engine (e.g., engine blocker on cooldown or person has anti-radar fitted). Always follow proper pullover procedure.</p>
              </li>
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Do <strong>not</strong> place barricades above or below ground level. Barricades must be placed realistically on the road surface.</p>
              </li>
              <li>
                <strong className="text-black">Barricade Safety <span className="text-red-600">(Power Gaming | Jail 120 min)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Do <strong>not</strong> place or remove barricades while holding a firearm.</p>
              </li>
              <li>
                <strong className="text-black">PDA Usage <span className="text-red-600">(Power Gaming | Jail 120 min)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Do <strong>not</strong> open or operate the PDA while holding a firearm.</p>
              </li>
              <li>
                <strong className="text-black">Weapon Discipline</strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Do <strong>not</strong> aim or point your weapon at a driver who is cooperating and not posing a threat.</p>
              </li>
            </ul>
          </section>
        </div>

        {/* 10-15 ARREST PROCEDURE */}
        <div className="pt-8 space-y-8">
          <h1 className="text-[28px] font-bold text-black mb-6">10-15 Arrest Procedure</h1>
          
          {/* Phase 1 */}
          <section id="phase-1" className="space-y-4 scroll-mt-8 section">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Phase 1: Cuffing & Securing</h2>
          ...
          <section id="phase-2" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Phase 2: Transport & Miranda Rights</h2>
            ...
            <div className="space-y-8">
              <div>
                ...
                <ul className="mt-3 space-y-2 list-disc pl-5 text-[#4b5563]">
                  <li>City speed limit: <span className="font-semibold text-black">120 mph</span></li>
          ...
          <section id="phase-3" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Phase 3: Legal & Medical Requests</h2>
          ...
          <section id="phase-4" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Phase 4: DOC Processing & Identification</h2>
          ...
          <section id="phase-5" className="space-y-4 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black border-b border-gray-100 pb-2">Phase 5: Charges & Imprisonment</h2>
          ...
          <section id="warnings" className="space-y-6 pt-4 border-t border-gray-100 scroll-mt-8">
            <h2 className="text-[22px] font-semibold text-black">
              Warnings & Strict Protocols (10-15)
            </h2>
            <p className="text-gray-600">
            ...
            <ul className="space-y-5 list-disc pl-5">
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">You must be standing or walking. Running cuff is not allowed.</p>
              </li>
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Do not cuff someone while they have a gun in hand.</p>
              </li>
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Only walk while dragging a cuffed suspect. Do not run or jump.</p>
              </li>
              <li>
                <strong className="text-black">Use Correct Vehicle Side <span className="text-red-600">(Power Gaming | Jail 120 min)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Stand on the same side as the seat you are placing the 10-15 into. Do not stand on the driver side and place them into the opposite passenger seat.</p>
              </li>
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Never tear the mask off a critically injured 10-15. Check their health first before forcing mask removal.</p>
              </li>
              <li>
                <strong className="text-black">Do Not Rush Confiscation <span className="text-red-600">(P.C. 4.2.2)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">If the suspect asks for a lawyer, handle the lawyer request first. Do not confiscate illegal items while the lawyer request is still pending.</p>
              </li>
              <li>
                <strong className="text-black">Lawyer Waiting Time</strong>
                <p className="text-[14px] text-[#4b5563] mt-2">If the 10-15 requests a lawyer, you must wait for 15 minutes. If the lawyer does not arrive within 15 minutes, you may proceed with processing the 10-15 normally.</p>
              </li>
              <li>
                <strong className="text-black">Lawyer Decisions</strong>
                <p className="text-[14px] text-[#4b5563] mt-2">The lawyer can suggest releasing the 10-15 if they see violations. However, the final decision is yours.</p>
              </li>
              <li>
                <strong className="text-black">Command Limitations <span className="text-red-600">(GR 6.1 | Warn)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Do not use the <code className="bg-gray-100 text-gray-800 px-1.5 py-0.5 rounded font-mono text-[12px]">/try Takes cell phone and radio out</code> command more than 2 times.</p>
              </li>
              <li>
                <strong className="text-black">Arrest Time Limit <span className="text-red-600">(SR 1.14 | Jail 120 min)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">After cuffing a suspect, you must complete the arrest within 25 minutes. This time may be extended if the 10-15 requests a lawyer or medical assistance (EMS).</p>
              </li>
              <li>
                <strong className="text-black">License Revocation Authority <span className="text-red-600">(P.C. 4.2.2)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">If you are not High Command, you must obtain permission from High Command or DOJ before revoking a 10-15's license.</p>
              </li>
              <li>
                <strong className="text-black">Department Radio Authority</strong>
                <p className="text-[14px] text-[#4b5563] mt-2">If you are not High Command, contact your High Command to make department radio announcements on your behalf.</p>
              </li>
              <li>
                <strong className="text-black">ID Disclosure Requirement <span className="text-red-600">(GR 6.4 | Warn)</span></strong>
                <p className="text-[14px] text-[#4b5563] mt-2">Never deny showing your ID to anybody under any circumstances unless you have an approved corrupt biography with that specific outcome.</p>
              </li>
              <li>
                ...
                <p className="text-[14px] text-[#4b5563] mt-2">Your bodycam must be recording before you engage with a 10-15. This protects both you and the suspect during the entire interaction. Keep the bodycam footage for 48 hours.</p>
              </li>
            </ul>
          </section>
        </div>

        {/* Video Tutorials - All 3 in a row */}
        <section id="video-tutorial" className="space-y-4 pt-4 border-t-2 border-gray-200 scroll-mt-8">
          <h2 className="text-[22px] font-semibold text-black">
            Video Tutorials
          </h2>
          <p className="text-gray-600">
            Watch these video demonstrations for complete training:
          </p>
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
            {/* Video 1: Phase 1 */}
            <div className="space-y-2">
              <h3 className="text-[14px] font-semibold text-black">Phase 1</h3>
              <a
                href="https://youtu.be/pAdu6QgpfG8"
                target="_blank"
                rel="noopener noreferrer"
                className="block relative rounded-[10px] overflow-hidden border border-[#e2e5ec] shadow-lg hover:shadow-xl transition-shadow group"
              >
                <img
                  src="/Guides/Thumbnails/Introduction To LSPD Phase 1.png"
                  alt="Phase 1 - Introduction To LSPD"
                  className="w-full h-auto object-cover"
                />
                {/* YouTube Play Icon */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <svg className="w-16 h-16 opacity-90 group-hover:opacity-100 group-hover:scale-110 transition-all" viewBox="0 0 68 48" fill="none">
            ...
            {/* Video 2: Phase 2 */}
            <div className="space-y-2">
              <h3 className="text-[14px] font-semibold text-black">Phase 2</h3>
              <a
                href="https://youtu.be/GtnHXY9q-qw"
                target="_blank"
                rel="noopener noreferrer"
                className="block relative rounded-[10px] overflow-hidden border border-[#e2e5ec] shadow-lg hover:shadow-xl transition-shadow group"
              >
                <img
                  src="/Guides/Thumbnails/Introduction To LSPD Phase 2.png"
                  alt="Phase 2 - 10-51 Procedure"
                  className="w-full h-auto object-cover"
                />
                {/* YouTube Play Icon */}
                <div className="absolute inset-0 flex items-center justify-center">
            ...
            {/* Video 3: Phase 3 */}
            <div className="space-y-2">
              <h3 className="text-[14px] font-semibold text-black">Phase 3</h3>
              <a
                href="https://youtu.be/z7aqlXcJh6o"
                target="_blank"
                rel="noopener noreferrer"
                className="block relative rounded-[10px] overflow-hidden border border-[#e2e5ec] shadow-lg hover:shadow-xl transition-shadow group"
              >
                <img
                  src="/Guides/Thumbnails/Introduction To LSPD Phase 3.png"
                  alt="Phase 3 - Complete 10-15 Procedure"
                  className="w-full h-auto object-cover"
                />
                {/* YouTube Play Icon */}
                <div className="absolute inset-0 flex items-center justify-center">
      ...
      <aside className="hidden lg:block w-[320px] shrink-0 sticky top-8 self-start">
        <div className="rounded-[8px] border border-[#e2e5ec] bg-white">
          <div className="py-3 px-4 border-b border-gray-100">
            <h3 className="text-[13px] font-bold text-[#000000]">
              Table of Contents
            </h3>
          </div>
          <nav className="h-[300px] overflow-y-auto p-2 space-y-0">
            <div className="text-[10px] font-bold uppercase tracking-wider text-gray-400 px-2.5 pb-1.5 select-none">
              10-51 Traffic Stop
            </div>
            ...
            <IndexLink href="#rules-1051">Warnings & Strict Protocols (10-51)</IndexLink>
            
            <div className="text-[10px] font-bold uppercase tracking-wider text-gray-400 px-2.5 pt-3.5 pb-1.5 border-t border-gray-100 mt-2 select-none">
              10-15 Arrest Procedure
            </div>
            ...
            <IndexLink href="#warnings">Warnings & Strict Protocols (10-15)</IndexLink>
            
            <div className="text-[10px] font-bold uppercase tracking-wider text-gray-400 px-2.5 pt-3.5 pb-1.5 border-t border-gray-100 mt-2 select-none">
              Tutorials
            </div>
            <IndexLink href="#video-tutorial">Video Tutorials</IndexLink>
          </nav>
        </div>
      </aside>
    </div>
...
function IndexLink({ href, children }: { href: string; children: ReactNode }) {
  ...
  return (
    <a
      href={href}
      onClick={handleClick}
      className="block py-1.5 px-3 text-[12px] text-[#666666] hover:text-[#000000] hover:underline transition-colors font-medium"
    >
      {children}
    </a>
  );
