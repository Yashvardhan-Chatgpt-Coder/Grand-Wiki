  ...
  return (
    <div className="flex h-screen w-screen bg-white text-zinc-950 overflow-hidden select-none">
      ...
      <div className="hidden lg:block w-1/2 h-full overflow-hidden shrink-0 bg-zinc-900 relative">
        ...
        />
        <Link to="/" className="absolute top-8 right-8 z-10 cursor-pointer">
          <img
            src="/Brand/Favicon.png"
            alt="Grand Wiki Logo"
            className="h-20 w-auto object-contain select-none drop-shadow-xl hover:scale-105 transition-transform"
          />
        </Link>
      </div>
    </div>
