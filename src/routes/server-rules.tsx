        ...
        <main className="min-h-0 flex-1 overflow-y-auto p-8">
          <div className="w-full space-y-2.5">
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">01.</span>
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">02.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">03.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Only one forum account is allowed across all Grand RP servers.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">04.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Players permanently banned on any Grand RP server cannot become administrators on any server.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">05.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Players must be 18 years or older in real life to become administrators.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">06.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">07.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">08.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                POV requests can be submitted for events including Revolver King, Grand Race, and drift competitions.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">09.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Unauthorized advertising using Grand RP's name results in a project blacklist.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">10.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Exploiting bugs related to in-game currency (GR 6.23) typically results in a permanent ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">11.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Unrealistic placement of Money Printing Machines (UB MPM) or dishes for hacker attacks typically results in a 7-day ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">12.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">13.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Bringing religion, politics, or racism into gameplay results in a ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">14.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">15.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Players with multiple ban records cannot become leaders or administrators.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">16.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Punishment history reviews check both of a player's accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">17.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Helping players evade bans or bypass server restrictions results in a permanent ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">18.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">19.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Verbal abuse in languages other than the server's native language is treated as an OOC insult.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">20.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">21.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Clearing your computer before a mandatory PC check results in permanent bans on both accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">22.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">23.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Using the /try command more than twice in a row counts as Fail RP.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">24.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Using commands meant for /try in /me or /do counts as Fail RP.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">25.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Typing entire words or sentences in all capital letters results in a chat mute.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">26.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">27.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
                Leaking confidential administrator information results in permanent bans on both accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-[#4b5563] dark:text-[#a0a5b1] shrink-0 w-[24px]">28.</span>
              <p className="text-[14px] leading-relaxed text-[#4b5563] dark:text-[#a0a5b1]">
