        ...
        <main className="min-h-0 flex-1 overflow-y-auto p-8">
          <div className="w-full space-y-2.5">
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">01.</span>
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">02.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">03.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Only one forum account is allowed across all Grand RP servers.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">04.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Players permanently banned on any Grand RP server cannot become administrators on any server.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">05.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Players must be 18 years or older in real life to become administrators.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">06.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">07.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">13.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Bringing religion, politics, or racism into gameplay results in a ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">14.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">15.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Players with multiple ban records cannot become leaders or administrators.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">16.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Punishment history reviews check both of a player's accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">17.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Helping players evade bans or bypass server restrictions results in a permanent ban.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">18.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">19.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Verbal abuse in languages other than the server's native language is treated as an OOC insult.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">20.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">21.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Clearing your computer before a mandatory PC check results in permanent bans on both accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">22.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">23.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Using the /try command more than twice in a row counts as Fail RP.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">24.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Using commands meant for /try in /me or /do counts as Fail RP.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">25.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Typing entire words or sentences in all capital letters results in a chat mute.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">26.</span>
              <p className="text-[14px] leading-relaxed text-white">
            ...
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">27.</span>
              <p className="text-[14px] leading-relaxed text-white">
                Leaking confidential administrator information results in permanent bans on both accounts.
              </p>
            </div>
            <div className="flex gap-3">
              <span className="text-[14px] text-white shrink-0 w-[24px]">28.</span>
              <p className="text-[14px] leading-relaxed text-white">
