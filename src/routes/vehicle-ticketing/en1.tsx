...
export const Route = createFileRoute("/vehicle-ticketing/en1")({
  head: () => ({
    meta: [{ title: "Vehicle Ticketing Tool - EN1 | Grand Wiki" }],
  }),
...
function VehicleTicketingPage() {
  return (
    <OrganizerLayout header={<SoftwareHeader title="Vehicle Ticketing Tool - EN1" />}>
      <div className="flex min-w-0 flex-1 flex-col min-h-0">
        <header className="shrink-0 border-b border-[#e7e9f0] bg-white px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
            <h1 className="text-[30px] font-semibold text-[#000000] leading-none">Vehicle Ticketing Tool - EN1</h1>
        ...
        <main className="min-h-0 flex-1 overflow-y-auto p-8">
          <VehicleTicketingTool server="en1" />
        </main>
      </div>
    </OrganizerLayout>
  );
