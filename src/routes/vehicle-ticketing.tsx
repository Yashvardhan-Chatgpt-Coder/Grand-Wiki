...
export const Route = createFileRoute("/vehicle-ticketing")({
  head: () => ({
    meta: [{ title: "Vehicle Ticketing Tool | Grand Wiki" }],
  }),
...
function VehicleTicketingPage() {
  return (
    <OrganizerLayout header={<SoftwareHeader title="Vehicle Ticketing Tool" />}>
      <div className="flex min-w-0 flex-1 flex-col min-h-0">
        <header className="shrink-0 border-b border-[#e7e9f0] bg-white px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3">
            <h1 className="text-[30px] font-semibold text-[#000000] leading-none">Vehicle Ticketing Tool</h1>
