...
export const Route = createFileRoute("/government/en3/templates")({
  head: () => ({
    meta: [{ title: "Document Templates - EN3 | Grand Wiki" }],
  }),
...
function ComingSoonPage() {
  return (
    <OrganizerLayout header={<SoftwareHeader title="Government Document Templates - EN3" />}>
      <div className="flex flex-1 flex-col items-center justify-center p-8 bg-[#fdfdfd] dark:bg-[#0c0d12]">
        <div className="max-w-md text-center space-y-4">
          ...
          <p className="text-[14px] text-[#5c6470] dark:text-[#9aa1b0] leading-relaxed">
            The Government Document Templates database for server EN3 is currently under preparation and will be available in a future system update.
          </p>
        </div>
      </div>
    </OrganizerLayout>
