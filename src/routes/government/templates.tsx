...
export const Route = createFileRoute("/government/templates")({
  head: () => ({
    meta: [{ title: "Government Templates | Grand Wiki" }],
  }),
...
function GovernmentTemplatesPage() {
  ...
  return (
    <OrganizerLayout header={<SoftwareHeader title="Government Document Templates" />}>
      <div className="flex min-w-0 flex-1 flex-col min-h-0">
        <main className="relative min-h-0 flex-1 overflow-y-auto px-8 pb-8 pt-6">
          <div className="space-y-6">
            <h2 className="text-[20px] font-semibold text-[#000000]">Document Templates</h2>
