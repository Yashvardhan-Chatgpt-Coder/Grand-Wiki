...
export const PATROLMAN_GUIDE_DATA: PatrolmanArticle[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { code: "P.C. 3.2.2", description: "Leading of a Riot", fine: "$30,000", time: "45", stars: "3" },
      { code: "P.C. 3.3.1", description: "Sedition as a Participant", fine: "$30,000", time: "45", stars: "3" },
      { code: "P.C. 3.3.2", description: "Leading of Sedition", fine: "$40,000", time: "60", stars: "4", highlight: "blacklist" },
      ...
      { code: "P.C. 3.9.1", description: "Collusion with Criminal Elements", fine: "$30,000", time: "45", stars: "3", highlight: "dismissal" },
      ...
      { code: "P.C. 3.12.1", description: "Disclosure of Information", fine: "$40,000", time: "60", stars: "4", highlight: "dismissal" },
      { code: "P.C. 3.12.2", description: "Disclosure of Classified Information", fine: "$50,000", time: "75", stars: "5", highlight: "dismissal" },
